...
This project is indexed by GitNexus as **QRoll** (732 symbols, 1076 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
