...
This project is indexed by GitNexus as **QRoll** (635 symbols, 864 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
