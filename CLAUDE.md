...
This project is indexed by GitNexus as **QRoll** (851 symbols, 1232 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
