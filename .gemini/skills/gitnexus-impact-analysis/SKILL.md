...
**mcp_gitnexus_impact** — the primary tool for symbol blast radius:
...
```
mcp_gitnexus_detect_changes({scope: "staged"})
...
```
1. mcp_gitnexus_impact({target: "validateUser", direction: "upstream"})
