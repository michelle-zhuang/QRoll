...
This project is indexed by GitNexus as **QRoll** (998 symbols, 1406 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
