...
This project is indexed by GitNexus as **QRoll** (633 symbols, 859 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
