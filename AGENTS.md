...
This project is indexed by GitNexus as **QRoll** (879 symbols, 1266 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
