...
This project is indexed by GitNexus as **QRoll** (1114 symbols, 1544 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
