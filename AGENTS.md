...
This project is indexed by GitNexus as **QRoll** (959 symbols, 1361 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
