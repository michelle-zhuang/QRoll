...
This project is indexed by GitNexus as **QRoll** (702 symbols, 1019 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
