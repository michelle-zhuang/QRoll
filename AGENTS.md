...
This project is indexed by GitNexus as **QRoll** (932 symbols, 1330 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
