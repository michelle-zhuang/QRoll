...
This project is indexed by GitNexus as **QRoll** (1083 symbols, 1500 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
